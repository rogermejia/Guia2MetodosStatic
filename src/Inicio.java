...
public class Inicio {
	//MODIFICACION PARA OPERAR CON METODOS STATIC
	public static void main(String[] args) {
		...
		System.out.println("Calculadora con métodos Static");
		...
		if (operacion==1) {
			CalculadoraDigital.suma(valor1, valor2);
		} else if (operacion==2) {
			CalculadoraDigital.resta(valor1, valor2);
		} else if (operacion==3) {
			CalculadoraDigital.multiplicacion(valor1, valor2);
		} else if (operacion==4) {
			CalculadoraDigital.division(valor1, valor2);
		}
	}
